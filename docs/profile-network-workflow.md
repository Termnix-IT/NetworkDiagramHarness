...
| `output/images/private/home-network-layout.svg` | 自分向け掲載用 SVG | no |
| `output/images/public/profile-home-lab-layout.svg` | 公開向け掲載用 SVG | no |
| `output/images/private/home-network-layout.png` | 自分向け掲載用 PNG | no |
| `output/images/public/profile-home-lab-layout.png` | 公開向け掲載用 PNG | no |
...
人間が見やすい固定配置 SVG を出力する場合は `export-layout` を使います。
